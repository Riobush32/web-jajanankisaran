        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <caption
                ...
                <button wire:click="add"
                    class="bg-teal-100 text-teal-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-teal-400 border border-teal-400">
                    add new product
                </button>
                ...
                @foreach($productData as $row)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4 text-right">
                            <a href="#paginated-product" <blade <blade
                                 @click="$dispatch('product-detail', { id: {{ $row->id }} })"
                                class="font-medium text-teal-600 dark:text-teal-500 hover:underline">detail</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
